...
public class ObjectSpawn : MonoBehaviour
{
	...
	void Start()
	{
		...
		StartCoroutine(DelayCoroutine(delay, () =>
		{
			...
			Instantiate(syougaibutu, new Vector2(6.0f, melodyscore[melodycount] + 1), Quaternion.identity);
			Instantiate(syougaibutu, new Vector2(6.0f, melodyscore[melodycount] - 2), Quaternion.identity);
